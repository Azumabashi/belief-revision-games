...
type
  ...
  BeliefRevisionGame* = object
    ...
    revisionOperators*: seq[proc (self: PropLogicFormula, context: seq[PropLogicFormula], interpretations: seq[Interpretation], allFormulae: seq[PropLogicFormula]): PropLogicFormula {.nimcall.}]
